            ...
            <div className="grid grid-cols-2 gap-3 mt-2">
              ...
              <div className="view__bottom__boxes">
                <p className="font-bold">
                  ₹ {data?.displayPrice ? data?.price?.disRate : "Not provided"}
                </p>
              </div>
            </div>
            <button
        ...
        <div className="view__under">
          ...
          <div className=" lg:mt-10  grid lg:grid-cols-4 lg:gap-7">
            <div className="lg:col-span-3">
              ...
              {data?.locationType != null ? (
                <div className="mt-10 ">
                  ...
                  >
                    {data?.locationType?.withinCommArea ? (
                      <p>
                        Within commercila area :{" "}
                    ...
                    {data?.locationType?.withinSpecialZone ? (
                      <p>
                        Within special zone :{" "}
                        <span className="font-bold">Yes</span>{" "}
                      </p>
              ...
              {data?.roadAccess != null ? (
                <div className="mt-10 ">
                  <h5 className="text-lg text-gray-800">Road access</h5>
              ...
              {data?.nearby ? (
                <div className="mt-7">
                  <h4 className="text-xl text-gray-800">Near by</h4>
                  <div
                    className="mt-2 bg-gray-50 border p-2   text-gray-900 "
                    style={{ fontFamily: "sans-serif ", fontSize: "15px" }}
                  >
                    <p>
                      {data?.nearby?.nearCommercialArea
                        ? "Near commercial area"
                        : ""}
                    </p>
                    <p>
                      {data?.nearby?.nearResidentialArea
                        ? "Near residential area"
                        : ""}
                    </p>
                    <p>
                      {data?.nearby?.nearTourismZone ? "Near tourism zone" : ""}
                    </p>

                    <p>{data?.nearby?.other ? data?.nearby?.other : ""}</p>
                  </div>
                </div>
              ) : (
                ""
            ...
            {data?.propType === "residential land" ? (
              <Nearby essential={data?.distance} />
            ) : (
              ""
            )}
          </div>
