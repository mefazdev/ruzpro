...
export default function ViewResidential() {
  ...
  const addToContacts = async () => {
    const res = await fetch(`${process.env.NEXT_PUBLIC_PORT}/api/contacts`, {
      method: "POST",
      headers: {
        ...
        <div className="lg:hidden">
          ...
          <div className="view__bottom">
            ...
            <div className="grid grid-cols-2 gap-3 mt-2">
              ...
              <div className="view__bottom__boxes flex">
                <p className="">{data?.bedrooms} Bathrooms</p>
              </div>
              <div className="view__bottom__boxes">
                <p>
        ...
        <div className="view__main mt-5 hidden lg:grid">
          ...
          <div className="mt-3 grid grid-cols-2 gap-6">
            ...
            <div className="relative">
              ...
              <div className="view__main__row mt-3">
                <div className="flex">
                  <BedRoundedIcon className="text-gray-500" />
              ...
              <div className="view__btn mt-2 ">
                <button onClick={viewContact}>View Contanct Details</button>
              </div>
        ...
        <div className="view__under">
          <div className=" lg:mt-10  grid lg:grid-cols-4 lg:gap-7">
            <div className="lg:col-span-3">
              <h4 className="text-lg lg:text-xl mt-0  text-gray-800">
                Description
              </h4>
