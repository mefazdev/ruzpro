...
import { Slide } from "@mui/material";import InsertPhotoIcon from '@mui/icons-material/InsertPhoto';
import CancelRoundedIcon from '@mui/icons-material/CancelRounded';
import KeyboardArrowUpIcon from '@mui/icons-material/KeyboardArrowUp';
import KeyboardArrowDownIcon from '@mui/icons-material/KeyboardArrowDown';
export default function MobComplitionStatus({ id, data }) {
  ...
  return (
    ...
    >
     ...
     className="bg-gray-200  rounded p-2 text-sm w-full  mt-2  flex justify-between"
     >Complition Status
